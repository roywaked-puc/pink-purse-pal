...
export function ServiceList() {
  ...
  const handleEdit = (id: string, description: string, amount: number, notes?: string) => {
    setEditingId(id);
            ...
            {editingId === service.id ? (
              ...
              <>
                <div className="flex-1">
                  ...
                  <p className="text-sm text-primary font-semibold">{formatCurrency(service.amount)}</p>
                  {service.notes && (
                ...
                <div className="flex gap-1">
                  <Button
                    size="icon"
                    variant="ghost"
                    onClick={() => handleEdit(service.id, service.description, service.amount, service.notes)}
                    className="h-8 w-8"
                  >
